    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content bg-body-highlight p-6">
            <div class="modal-header justify-content-center border-0 p-0 mb-2">
                <h3 class="mb-0" id="header-modal-Authv2"><i class="fas fa-file-signature"></i> Tipo de Facturacion</h3>
            ...
            <div class="modal-footer border-0 pt-6 px-0 pb-0 justify-content-center">
                <div class="d-flex justify-content-center w-100">
                    <button class="btn btn-primary mx-2 my-0" id="button-save-normal" onclick="setFacturaType(1)"><i class="fas fa-bookmark"></i> &nbsp; Normal</button>
                    <!-- <button class="btn btn-success mx-2 my-0" id="button-save-salud" onclick="setFacturaType(2)"><i class="fas fa-bookmark"></i> &nbsp; Salud</button> -->
                </div>
            </div>
        </div>
    </div>
