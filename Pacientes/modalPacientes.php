        ...
        <div class="steps-container mb-4">
          <ul class="steps">
            ...
            <li class="step" data-step="2">
              ...
              <span class="step-label">Datos Medicos</span>
            </li>
                ...
                <div class="col-8 col-sm-6">
                  ...
                  <div class="input-group">
                    <div class="form-floating">
                      <select class="form-select" name="tipoDocumento" id="tipoDocumento" required>
                        ...
                        <option value="ti">TI - Tarjeta de Indentidad</option>
                      </select>
                    ...
                    <div class="form-floating mb-3">
                      <input type="number" class="form-control" min="0" id="documentoPaciente" required
                  ...
                  <div class="mb-2 form-floating">
                    <select class="form-select" id="genero" name="genero">
                      ...
                      <option value="I">Inderteminado</option>
